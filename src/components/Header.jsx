  ...
  return (
    <header className="pb-12 flex justify-between dark:bg-black">
      ...
      <div className="flex items-center">
        <FontPicker font={props.font} onFontClick={props.onFontChange} fontWindow={props.fontWindow} fontWindowToggle={props.fontWindowToggle} />
        <label class="inline-flex relative items-center mr-5 cursor-pointer">
          <input type="checkbox" className="sr-only peer" checked={props.theme} readOnly />
